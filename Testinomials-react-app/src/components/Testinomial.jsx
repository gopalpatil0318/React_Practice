...
const Testinomial = (props) => {
  ...
  return (
    ...
    mt-10 p-10  transition-all duration-700 hover:shadow-xl rounded-md'>
      ...
      <div className='flex text-3xl mt-10 gap-3  text-violet-400 font-bold mx-auto justify-center'>
        <button
      ...
      <div className='mt-6'>
        <button
          ...
          className='bg-violet-400 hover:bg-violet-400 transition-all duration-200 cursor-pointer
